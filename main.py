...
# --- 1. NEZASTAVITEĽNÝ HTTP SERVER PRE RAILWAY ---
...
class HealthHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"Riobot is alive")
...
def run_server():
    while True:
        try:
            ...
            print(f"HTTP server restart: {e}")
            time.sleep(2)

# Spustenie servera na pozadí hneď v prvej sekunde
...
async def main():
    print("Riobot štartuje hlavnú rutinu...")
    ...
    while True:
        ...
        try:
            ...
            print(f"Kritická chyba v pripojení/behu, obchádzam pád a skúšam znova o 10s: {e}")
            try:
                if connection:
