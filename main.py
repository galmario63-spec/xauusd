...
BTC_LOT = 0.10
GOLD_LOT = 0.02  # Zvýšené na 0.02 lotu
...
async def run_bot():
    ...
    send_telegram("🚀 Riobot štartuje (Zlato 0.02 lot, BE pri +6 na +1.5)...")
    ...
    while True:
        try:
            ...
            send_telegram("🚀 Riobot pripojený a stráži trhy (Zlato 0.02 lot)! ")
